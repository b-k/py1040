...
local_taxes=cell('State/local Income OR general sales tax', 5, 'local_taxes', flag='u', situation=itemizing),
real_estate_taxes=cell('Real estate taxes', 6, 'real_estate_taxes', flag='u', situation=itemizing),
property_taxes=cell('Personal property taxes', 7, 'property_taxes', flag='u', situation=itemizing),
other_taxes=cell('Other taxes', 8, 'other_taxes', flag='u', situation=itemizing),
...
mort_insurance=cell('Mortgage insurance premia', 13, 'mort_insurance_premia', flag='u', situation=itemizing),
investment_interest=cell('Investment interest', 14, 'investment_interest',  flag='u', situation=itemizing),
...
charity_cash=cell("Gifts to charity by cash or check", 16, 'charity_cash', flag='u', situation=itemizing),
charity_noncash=cell("Gifts to charity other than by cash or check", 17, 'charity_noncash', flag='u', situation=itemizing),
charity_carryover=cell("Gifts to charity, carryover from prior year", 18, 'charity_carryover', flag='u', situation=itemizing),
...
casualty_or_theft_losses=cell("Casualty and Theft Losses", 20, 'casualty_or_theft_losses', flag='u', situation=itemizing),

employee_expenses=cell("Unreimbursed employee expenses—job travel, union dues, job education, etc.", 21, 'employee_expenses', flag='u', situation=itemizing),
tax_prep_fees=cell("Tax prep fees", 22, 'tax_prep_fees', flag='u', situation=itemizing),
other_work_expenses=cell("Other expenses—investment, safe deposit box, etc.", 23, 'other_work_expenses', flag='u', situation=itemizing),
...
other_deductions=cell("Other deductions", 28, 'other_deductions', flag='u', situation=itemizing),
