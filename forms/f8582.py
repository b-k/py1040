...
f8582_net_in=cell(1.0, "Net income", "CV('ws1_8582_net_gain')", ('ws1_8582_net_gain',)),
f8582_net_loss=cell(1.2, "Net loss", "CV('ws1_8582_net_loss')", ('ws1_8582_net_loss',)),
f8582_carryover=cell(1.4, "Prior year carryover", "CV('ws1_8582_prior_loss')", ('ws1_8582_prior_loss',)),
f8582_total_real_in=cell(1.6, "Sum", "CV('f8582_net_in') + CV('f8582_net_loss') + CV('f8582_carryover')", 
